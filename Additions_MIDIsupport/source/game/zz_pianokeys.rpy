...
#        CONFIG_CHANGE = "monika 3a"
        ...
        def __init__(self, mode, pnml=None):
            ...
            # setup MIDI keys
            self.mkeys = {
                77: mas_piano_keys.F4,
                78: mas_piano_keys.F4SH,
                79: mas_piano_keys.G4,
                80: mas_piano_keys.G4SH,
                81: mas_piano_keys.A4,
                82: mas_piano_keys.A4SH,
                83: mas_piano_keys.B4,
                84: mas_piano_keys.C5,
                85: mas_piano_keys.C5SH,
                86: mas_piano_keys.D5,
                87: mas_piano_keys.D5SH,
                88: mas_piano_keys.E5,
                89: mas_piano_keys.F5,
                90: mas_piano_keys.F5SH,
                91: mas_piano_keys.G5,
                92: mas_piano_keys.G5SH,
                93: mas_piano_keys.A5,
                94: mas_piano_keys.A5SH,
                95: mas_piano_keys.B5,
                96: mas_piano_keys.C6
            }
...
#                    renpy.force_full_redraw()
        ...
        def midiCallback(self):
            while True:
                if len(MASM_DataCommunicator.data) > 0:
                    for dat in MASM_DataCommunicator.data:
                        if dat.startswith('note'):
                            ...
                            MASM_DataCommunicator.data.remove(dat)
